...
from closeapproachdata_sdk.utility import register

# Load features
from closeapproachdata_sdk.feature.base_feature import CloseApproachDataBaseFeature
from closeapproachdata_sdk.features import _has_feature, _make_feature
...
class CloseApproachDataSDK:
    ...
    def get_utility(self):
        return CloseApproachDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CloseApproachDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Cadapi(self, data=None) -> "CadapiEntity":
        ...
        from closeapproachdata_sdk.entity.cadapi_entity import CadapiEntity
