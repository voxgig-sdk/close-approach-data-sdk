# CloseApproachData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CloseApproachDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CloseApproachDataSDK(...) and CloseApproachDataSDK.test(...) become
#      CloseApproachDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "closeapproachdata_sdk"
_SDK_CLASS = "CloseApproachDataSDK"
