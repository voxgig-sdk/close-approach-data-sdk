...
import (
	...
	vs "github.com/voxgig-sdk/close-approach-data-sdk/go/utility/struct"
)

type CadapiEntity struct {
	name    string
	client  *core.CloseApproachDataSDK
...
func NewCadapiEntity(client *core.CloseApproachDataSDK, entopts map[string]any) *CadapiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CadapiEntity) GetName() string { return e.name }
...
func (e *CadapiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CadapiEntity) Deleted() bool {
	return e.deleted
}


func (e *CadapiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCadapiEntity(e.client, opts)
}

func (e *CadapiEntity) Data(args ...any) any {
...
func (e *CadapiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cadapi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CadapiEntity) DataTyped(data ...Cadapi) Cadapi {
	if len(data) > 0 {
		return typedFrom[Cadapi](e.Data(asMap(data[0])))
	}
	return typedFrom[Cadapi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cadapi (all fields
// optional at the wire level).
func (e *CadapiEntity) MatchTyped(match ...Cadapi) Cadapi {
	if len(match) > 0 {
		return typedFrom[Cadapi](e.Match(asMap(match[0])))
	}
	return typedFrom[Cadapi](e.Match())
}
...
func (e *CadapiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CadapiEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CadapiEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CadapiListMatch and returns []Cadapi. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CadapiEntity) ListTyped(reqmatch CadapiListMatch, ctrl map[string]any) ([]Cadapi, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Cadapi](res), nil
}



func (e *CadapiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CadapiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CadapiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CadapiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
