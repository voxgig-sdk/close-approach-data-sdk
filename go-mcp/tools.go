...
type Args struct {
	Entity string         `json:"entity" jsonschema:"cadapi"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.CloseApproachDataSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "close-approach-data_list",
		Description: "List records from CloseApproachData. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "close-approach-data_load",
		Description: "Load a single record from CloseApproachData. " +
...
func runOp(client *sdk.CloseApproachDataSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.CloseApproachDataSDK, name string) (sdk.CloseApproachDataEntity, error) {
	switch strings.ToLower(name) {
	case "cadapi":
		return client.Cadapi(nil), nil
