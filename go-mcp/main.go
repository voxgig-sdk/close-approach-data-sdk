// Command CloseApproachData-mcp is an MCP server exposing the CloseApproachData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	CloseApproachData_list  — list records of an entity
//	CloseApproachData_load  — load a single record of an entity
//
