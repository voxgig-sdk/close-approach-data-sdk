...
AQL-driven CLI and REPL for the CloseApproachData SDK. Positional arguments are
...
```sh
go build -o close-approach-data-cli ./...
```
...
./close-approach-data-cli load 1 cadapi
./close-approach-data-cli load '{id:1}' cadapi
