...
func registerSDKWords(r *eng.Registry, client *sdk.CloseApproachDataSDK) {
...
func runOp(client *sdk.CloseApproachDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
