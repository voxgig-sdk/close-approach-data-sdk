...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/close-approach-data` | `npm install @voxgig-sdk/close-approach-data` |
| Python | `voxgig-sdk-close-approach-data` | `pip install voxgig-sdk-close-approach-data` |
| PHP | `voxgig-sdk/close-approach-data` | `composer require voxgig-sdk/close-approach-data` |
| Golang | `github.com/voxgig-sdk/close-approach-data-sdk/go` | `go get github.com/voxgig-sdk/close-approach-data-sdk/go` |
| Ruby | `voxgig-sdk-close-approach-data` | `gem install voxgig-sdk-close-approach-data` |
| Lua | `voxgig-sdk-close-approach-data` | `luarocks install voxgig-sdk-close-approach-data` |
