...
This API provides access to current close-approach data for all asteroids and comets in JPL's SBDB (Small-Body DataBase).

Learn more about Close Approach Data API at [ssd-api.jpl.nasa.gov/doc/cad.html](https://ssd-api.jpl.nasa.gov/doc/cad.html).
