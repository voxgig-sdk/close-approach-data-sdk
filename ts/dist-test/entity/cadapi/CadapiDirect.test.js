...
(0, node_test_1.describe)('CadapiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.CloseApproachDataSDK({
    ...
    (0, node_test_1.test)('direct-list-cadapi', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-cadapi', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.CLOSE_APPROACH_DATA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CloseApproachDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['CLOSE_APPROACH_DATA_TEST_CADAPI_ENTID'];
    ...
    const client = new __1.CloseApproachDataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=CadapiDirect.test.js.map