...
#      offline in seeded test mode (CloseApproachDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "CloseApproachData_sdk.rb")
  SDK_CLASS = "CloseApproachDataSDK"
  ...
  SDK_BASE = "CloseApproachData_sdk"
