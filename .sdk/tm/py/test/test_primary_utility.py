...
from projectname_sdk import CloseApproachDataSDK
from projectname_sdk.core.spec import CloseApproachDataSpec
from projectname_sdk.core.result import CloseApproachDataResult
from projectname_sdk.core.response import CloseApproachDataResponse
from projectname_sdk.core.operation import CloseApproachDataOperation
from projectname_sdk.core.error import CloseApproachDataError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import CloseApproachDataBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return CloseApproachDataError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except CloseApproachDataError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = CloseApproachDataResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = CloseApproachDataSDK.test(None, None)
        ...
        class TestInitFeature(CloseApproachDataBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CloseApproachDataBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = CloseApproachDataSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = CloseApproachDataSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CloseApproachDataSpec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CloseApproachDataSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CloseApproachDataSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = CloseApproachDataOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CloseApproachDataSDK.test(None, setup_opts)
