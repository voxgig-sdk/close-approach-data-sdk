...
from projectname_sdk.core.control import CloseApproachDataControl
...
class CloseApproachDataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = CloseApproachDataControl()
        ...
        if isinstance(sp, CloseApproachDataSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, CloseApproachDataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, CloseApproachDataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return CloseApproachDataOperation({})
    ...
    def make_error(self, code, msg):
        return CloseApproachDataError(code, msg, self)
