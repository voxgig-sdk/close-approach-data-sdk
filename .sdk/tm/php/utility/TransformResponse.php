...
// CloseApproachData SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class CloseApproachDataTransformResponse
{
    public static function call(CloseApproachDataContext $ctx): mixed
    {
        ...
        $transform = CloseApproachDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
