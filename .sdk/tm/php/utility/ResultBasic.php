...
// CloseApproachData SDK utility: result_basic

class CloseApproachDataResultBasic
{
    public static function call(CloseApproachDataContext $ctx): ?CloseApproachDataResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof CloseApproachDataError) ? $result->err->msg : (string)$result->err;
