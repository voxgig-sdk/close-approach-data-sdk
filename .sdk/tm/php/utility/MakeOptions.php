...
// CloseApproachData SDK utility: make_options

class CloseApproachDataMakeOptions
{
    ...
    public static function call(CloseApproachDataContext $ctx): array
    {
        ...
        //
        // `CloseApproachDataSchema::optspec()` is built from the model:
        ...
        $optspec = CloseApproachDataSchema::optspec();
