...
// CloseApproachData SDK utility: graphql
//
...
class CloseApproachDataGraphql
{
    ...
    // equivalent.
    public static function body(CloseApproachDataContext $ctx): mixed
    {
    ...
    public static function errors(CloseApproachDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
