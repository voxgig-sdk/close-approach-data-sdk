...
// CloseApproachData SDK ratelimit feature
...
class CloseApproachDataRatelimitFeature extends CloseApproachDataBaseFeature
{
    ...
    private function _acquire(CloseApproachDataContext $ctx): void
    {
    ...
    private function _track(CloseApproachDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
