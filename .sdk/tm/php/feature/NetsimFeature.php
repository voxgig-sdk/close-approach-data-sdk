...
// CloseApproachData SDK netsim feature
...
class CloseApproachDataNetsimFeature extends CloseApproachDataBaseFeature
{
    ...
    private function _simulate(CloseApproachDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CloseApproachDataContext $ctx, array $applied): void
    {
        $client = $this->client;
