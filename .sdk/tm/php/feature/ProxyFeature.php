...
// CloseApproachData SDK proxy feature
...
class CloseApproachDataProxyFeature extends CloseApproachDataBaseFeature
{
    ...
    public function init(CloseApproachDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CloseApproachDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
