...
// CloseApproachData SDK rbac feature
...
class CloseApproachDataRbacFeature extends CloseApproachDataBaseFeature
{
    ...
    private function _required(CloseApproachDataContext $ctx): ?string
    {
    ...
    private function _reject(CloseApproachDataContext $ctx, string $required): void
    {
    ...
    private function _track(CloseApproachDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
