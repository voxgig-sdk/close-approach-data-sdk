...
// CloseApproachData SDK timeout feature
...
class CloseApproachDataTimeoutFeature extends CloseApproachDataBaseFeature
{
    ...
    private function _with_timeout(CloseApproachDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CloseApproachDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
