...
|---|---|---|
| `ts/` | @voxgig-sdk/close-approach-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/close-approach-data-sdk \
      --repository voxgig-sdk/close-approach-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/close-approach-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/close-approach-data-sdk --id=<id>` removes it.
