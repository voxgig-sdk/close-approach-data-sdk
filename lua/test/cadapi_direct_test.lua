...
describe("CadapiDirect", function()
  it("should direct-list-cadapi", function()
    local setup = cadapi_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cadapi", setup.live and "live" or "unit")
...
function cadapi_direct_setup(mockres)
