...
local CadapiEntity = {}
CadapiEntity.__index = CadapiEntity


function CadapiEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CadapiEntity)
  self._name = "cadapi"
  self._client = client
...
function CadapiEntity:get_name()
  return self._name
end


function CadapiEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CadapiEntity.new(self._client, opts)
end
...
function CadapiEntity:mark_deleted()
  self._deleted = true
end


function CadapiEntity:deleted()
  return true == self._deleted
end


function CadapiEntity:data_set(args)
  if args ~= nil then
...
function CadapiEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CadapiEntity:match_set(args)
  if args ~= nil then
...
function CadapiEntity:match_get()
...
function CadapiEntity:stream(action, args, callopts)
...
function CadapiEntity:_run_op(ctx, post_done)
  local utility = self._utility
