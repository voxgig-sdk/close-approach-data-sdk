...
local function make_error_util(ctx, err)
  ...
  local msg = "CloseApproachDataSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = CloseApproachDataError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == CloseApproachDataError then
