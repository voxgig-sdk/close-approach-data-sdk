...
// CloseApproachData SDK telemetry feature
...
class CloseApproachDataTelemetryFeature extends CloseApproachDataBaseFeature
{
    ...
    private function _close(CloseApproachDataContext $ctx, bool $ok): void
    {
