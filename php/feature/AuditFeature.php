...
// CloseApproachData SDK audit feature
...
class CloseApproachDataAuditFeature extends CloseApproachDataBaseFeature
{
    ...
    private function _emit(CloseApproachDataContext $ctx, string $outcome): void
    {
