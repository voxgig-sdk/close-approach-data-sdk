...
// CloseApproachData SDK cache feature
...
class CloseApproachDataCacheFeature extends CloseApproachDataBaseFeature
{
    ...
    private function _through(CloseApproachDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
