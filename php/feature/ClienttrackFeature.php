...
// CloseApproachData SDK clienttrack feature
...
class CloseApproachDataClienttrackFeature extends CloseApproachDataBaseFeature
{
    ...
    public function PostConstruct(CloseApproachDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'CloseApproachData-SDK';
