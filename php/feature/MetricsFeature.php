...
// CloseApproachData SDK metrics feature
...
class CloseApproachDataMetricsFeature extends CloseApproachDataBaseFeature
{
    ...
    private function _record(CloseApproachDataContext $ctx, bool $ok): void
    {
