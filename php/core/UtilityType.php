...
// CloseApproachData SDK utility type

class CloseApproachDataUtility
{
    ...
    public static function copy(CloseApproachDataUtility $src): CloseApproachDataUtility
    {
        $u = new CloseApproachDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
