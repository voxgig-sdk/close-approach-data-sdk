...
// CloseApproachData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CloseApproachDataSDK::test)
...
{
    private const SDK_CLASS = 'CloseApproachDataSDK';
    ...
    private const SDK_BASE = 'closeapproachdata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../closeapproachdata_sdk.php';
