...
class CadapiDirectTest extends TestCase
{
    public function test_direct_list_cadapi(): void
    {
        $setup = cadapi_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-cadapi", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
