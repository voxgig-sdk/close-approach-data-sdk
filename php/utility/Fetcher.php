...
// CloseApproachData SDK utility: fetcher

class CloseApproachDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CloseApproachDataSDK/1.0)';
    ...
    public static function call(CloseApproachDataContext $ctx, string $fullurl, array $fetchdef): array
    {
