...
// CloseApproachData SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CloseApproachDataMakeRequest
{
    public static function call(CloseApproachDataContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CloseApproachDataResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CloseApproachDataResponse($fetched);
        } else {
